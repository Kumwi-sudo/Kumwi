...
local function _0x9s0t1u()
    local _0x2v3w4x, _0x5y6z7a = pcall(function()
        return game:HttpGet("https://raw.githubusercontent.com/yourusername/yourrepo/main/whitelist.txt")
    end)
    if _0x2v3w4x then
        local _0x8b9c0d = {}
        for _0x1e2f3g in _0x5y6z7a:gmatch("[^\r\n]+") do
            table.insert(_0x8b9c0d, _0x1e2f3g)
        end
        return _0x8b9c0d
    else
        return {"username1","username2","kumkki"}
    end
end
_0x1a2b3c.Whitelist = _0x9s0t1u()
local function _0x4h5i6j()
    local _0x7k8l9m = game:GetService("RbxAnalyticsService"):GetClientId()
    return _0x7k8l9m
end
local function _0x0n1o2p()
    local _0x3q4r5s = game.Players.LocalPlayer.Name
    for _, _0x6t7u8v in pairs(_0x1a2b3c.Whitelist) do
        if _0x3q4r5s == _0x6t7u8v then
            return true
        end
    end
    return false
